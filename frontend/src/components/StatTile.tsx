...
export function StatTile({ label, value, hint }: StatTileProps) {
  return (
    <div className="rounded-lg border border-slate-200 border-l-4 border-l-indigo-500 bg-white p-4 dark:border-slate-800 dark:border-l-indigo-400 dark:bg-slate-900">
